    ...
    // ▪️ Textura 1x1 para dibujar líneas
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Mouse.GetState().LeftButton == ButtonState.Pressed &&
                botonToggle.Contains(Mouse.GetState().Position))
            {
                verArbol = !verArbol;
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw(_blackCanvas, new Rectangle(550, 0, 730, 720), Color.Black); //Lienzo negro
            ...
            {
                // Lienzo
                _spriteBatch.Draw(_blackCanvas, new Rectangle(550, 0, 730, 720), Color.Black * 0.8f);
